...
wget -q "https://github.com/ValveSoftware/wine/archive/wine-${WINE_VERSION}.tar.gz"
tar xf "wine-${WINE_VERSION}.tar.gz" || die "* cant extract wine!"
mv "wine-wine-${WINE_VERSION}" "wine-src" || die "* cant rename wine-src!"
