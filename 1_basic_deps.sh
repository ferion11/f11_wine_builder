...
sudo apt-get -q -y install mingw-w64 ccache libfreetype6-dev:i386 libfontconfig1-dev:i386 libglu1-mesa-dev:i386 libosmesa6-dev:i386 libvulkan-dev:i386 libvulkan1 libvulkan1:i386 libpulse-dev:i386 libopenal-dev:i386 libncurses-dev:i386 libldap-dev:i386 libcapi20-dev:i386 libpcap-dev:i386 libmpg123-dev:i386 libgphoto2-dev:i386 libsane-dev:i386 libkrb5-dev:i386 libgsm1-dev:i386 libv4l-dev:i386 libgstreamer1.0-dev libudev-dev:i386 libxi-dev:i386 liblcms2-dev:i386 libibus-1.0-dev:i386 ocl-icd-opencl-dev:i386 libxinerama-dev:i386 libxcursor-dev:i386 libxrandr-dev:i386 libxcomposite-dev:i386 libavcodec57:i386 libavcodec-dev:i386 libswresample2:i386 libswresample-dev:i386 libavutil55:i386 libavutil-dev:i386 libusb-1.0-0-dev libusb-1.0-0-dev:i386 libasound2-dev:i386 libjpeg-dev:i386 libldap2-dev:i386 libx11-dev:i386 zlib1g-dev:i386 libcups2:i386 libdbus-1-3:i386 libicu-dev libncurses5:i386 libwxgtk3.0-gtk3-dev libsdl2-dev:i386 libfaudio-dev:i386 libfaudio0:i386 libvkd3d-dev:i386 libxss-dev oss4-dev libgcrypt20-dev:i386 libtiff-dev:i386 libcupsimage2-dev:i386 libgstreamer-plugins-base1.0-dev:i386 libgnutls28-dev:i386 libxml2-dev:i386 libgtk-3-dev:i386 libxslt1-dev:i386 libva-dev:i386 libgdk-pixbuf2.0-dev:i386 libjxr-dev:i386 || die "* main apt erro!"
